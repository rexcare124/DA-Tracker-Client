import DisciplinaryTacticsSection from "@/components/DisciplinaryTacticsSection";
...
export default function Home() {
  return (
    <main className="min-h-screen hero-bg">
      ...
      <div
        id="home"
        className="relative z-10 container mx-auto px-4 pt-24 md:pt-28 pb-12"
      >
        ...
        <section
          id="view-data"
          className="mt-8 md:mt-12 pt-8 pb-8 mb-8 md:mb-12"
        >
        ...
        {/* Disciplinary Tactics & Techniques Section */}
        <DisciplinaryTacticsSection />
