...
export type ValidCategory =
  (typeof VALID_CATEGORIES)[keyof typeof VALID_CATEGORIES];
...
export class StaticOptionsService {
  ...
  static async getActiveOptions(
    ...
    try {
      ...
      console.error(
        `[StaticOptionsService] Failed to get options for category ${category}:`,
        error,
      );
   ...
   */
  static async idsToHistoricalStrings(
    category: string,
    ids: number[],
  ...
  static async updateOptionText(
    ...
    // return newOption;
    return { id: 0, category: "", value: "", version: 0, isActive: false };
  }
